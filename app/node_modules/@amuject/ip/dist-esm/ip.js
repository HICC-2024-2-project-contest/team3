...
const bogonIPs = JSON.parse(fs.readFileSync(path.resolve(___dirname, '../data/bogon-ips.json')).toString());
const regexp = {
...
class IP {
    ...
    to6() {
        if (this.is4()) {
            ...
            return new IP('0000:0000:0000:0000:0000:ffff:' +
    ...
    in(i1, i2) {
        if (i1.hasSubnet()) {
            ...
            return (subnet.range.start.toDemical() <= this.#ip &&
